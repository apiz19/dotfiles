...
export GIMP_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/gimp-2.8"
export MAKEPKG_CONFIG="${XDG_CONFIG_HOME:-$HOME/.config}/.makepkg.conf"
export THUMBNAILS_DIR="${XDG_DATA_HOME:-$HOME/.local/share}/.thumbnails"
export ICONS_DIR="${XDG_DATA_HOME:-$HOME/.local/share}/.icons"
...
export ROFI_SEARCH_CMD='brave $URL'
# export TITLE_COLOR="38;5;160;48;5;240"	
# export ROFI_SEARCH_TIMEOUT=true
export BIB="$HOME/Documents/LaTeX/TGA_better.bib"
